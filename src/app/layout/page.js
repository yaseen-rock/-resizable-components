...
const icon1 = (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M15.5 11.916L27 5.278L19.5.938a7 7 0 0 0-7 0l-8 4.62A7 7 0 0 0 1 11.62v9.237a7 7 0 0 0 3.5 6.061l7.5 4.33V17.98a7 7 0 0 1 3.5-6.062zM10 27.786v-9.809a9 9 0 0 1 4.5-7.792l8.503-4.91L18.5 2.67a5 5 0 0 0-5 0l-8 4.619A5 5 0 0 0 3 11.62v9.238a5 5 0 0 0 2.5 4.33z"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M18.409 13.55a7 7 0 0 1 1.035 1.711A6.9 6.9 0 0 1 20 17.98v13.27l7.5-4.33a7 7 0 0 0 3.5-6.061V11.62a7 7 0 0 0-1.587-4.422zm2.777.705A8.9 8.9 0 0 1 22 17.979v9.807l4.5-2.597a5 5 0 0 0 2.5-4.33V11.62c0-.588-.106-1.161-.303-1.7z"
      ...
      <div key="1">
        <Card style={{ height: "100%" }}>
          ...
          >
            ...
            >
              DataNeuron augments human expertise through various approaches
              like recognize vs recall with the proprietary ensemble models
              (unsupervised, semi-supervised and supervised) to achieve
              comparable/ better accuracies to HITL and pre-trained LLMs.
            </Typography>
            <TextField
              label="Feedback"
              variant="outlined"
            ...
            <Badge badgeContent={addBadgeCounts[0]} color="secondary">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleAddFeedback(feedback1, 0)}
            ...
            <Badge
              badgeContent={updateBadgeCounts[0]}
              color="secondary"
            ...
            >
              <Button
                ...
                color="secondary"
                onClick={() =>
                  handleUpdateFeedback(feedbackData[0]._id, feedback1, 0)
                }
              >
                Update
              </Button>
        ...
        <Card style={{ height: "100%" }}>
          ...
          >
            ...
            <Typography
              ...
              style={{ marginTop: "20px" }}
            >
              DSEAL is a proprietary algorithm developed by DataNeuron
              scientists to achieve state-of-the-art accuracy with the smallest
              data sample size possible while utilizing the full potential of
              active-learning methods. DSEAL integrates seamlessly with
            ...
            <Badge badgeContent={addBadgeCounts[1]} color="secondary">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleAddFeedback(feedback2, 1)}
                style={{ marginBottom: "5px" }}
              >
                Add
              </Button>
            ...
            <Badge
              badgeContent={updateBadgeCounts[1]}
              color="secondary"
              style={{ marginLeft: "8px" }}
            >
              <Button
                ...
                color="secondary"
                onClick={() =>
                  handleUpdateFeedback(feedbackData[1]._id, feedback2, 1)
                }
              >
                Update
              </Button>
        ...
        <Card style={{ height: "100%" }}>
          ...
          >
            ...
            <Typography
              ...
              style={{ marginTop: "20px" }}
            >
              Once the Data Labeling is complete using DataNeuron automate the
              model training/ fine-tuning pipeline with a no-code workflow.
              Platform also provides ready-to-use API for prediction and
              integration with AI products. It further captures the feedback for
              model improvements / versioning.
            </Typography>
            <TextField
              label="Feedback"
              variant="outlined"
            ...
            <Badge badgeContent={addBadgeCounts[2]} color="secondary">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleAddFeedback(feedback3, 2)}
                style={{ marginBottom: "5px" }}
              >
                Add
              </Button>
            ...
            <Badge
              badgeContent={updateBadgeCounts[2]}
              color="secondary"
              style={{ marginLeft: "8px" }}
            >
              <Button
                ...
                color="secondary"
                onClick={() =>
                  handleUpdateFeedback(feedbackData[2]._id, feedback3, 2)
                }
              >
                Update
              </Button>
